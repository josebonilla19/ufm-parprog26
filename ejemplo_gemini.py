...
# La API key se lee de una variable de entorno para no dejarla escrita
# en el codigo (este repo es publico). Antes de correr el script:
#   export GEMINI_API_KEY="tu-key-de-google-ai-studio"
